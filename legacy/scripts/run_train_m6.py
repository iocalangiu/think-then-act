...
Run with:
    ...
    modal run --detach scripts/run_train_m6.py --n-iterations 100

W&B (optional):
    modal secret create wandb-secret WANDB_API_KEY=<your-key>
    modal run --detach scripts/run_train_m6.py --wandb-project rl-harness-robotics
...
def run_training(
    ...
    from think_then_act.training.grpo_trainer import GRPOTrainer, GRPOConfig
