...
Run with:
    modal run run_episode.py --seed 0                    # base model (no LoRA)
    modal run run_episode.py --seed 0 --lora sft_warmstart
    modal run run_episode.py --seed 0 --lora grpo_m6c_iter_15
